...
_C.MODEL.PRETRAIN_PATH = 'D:\liuguangjie\code4\SOLIDER-ReID\checkpoint_tea.pth'
...
_C.MODEL.TRANSFORMER_TYPE = 'swin_base_patch4_window7_224'
...
_C.DATASETS.NAMES = ('dukemtmcreid')
